...
describe('createClass()', function(){
  ...
  it('createClass() returns an object with the correct API', function(done){
    ...
    expect(base.fetch).toEqual(jasmine.any(Function), 'Public API: fetch() not exposed');
    expect(base.update).toEqual(jasmine.any(Function), 'Public API: update() not exposed');
    expect(base.post).toEqual(jasmine.any(Function), 'Public API: post() not exposed');
    expect(base.removeBinding).toEqual(jasmine.any(Function), 'Public API: removeBinding() not exposed');
  ...
  it('createClass() should throw if not passed an initialized firebase database instance', function(){
    expect(function(){
      Rebase.createClass({});
    }).toThrow(new Error('REBASE: Rebase.createClass failed. Expected an initialized firebase database object.'));
    expect(function(){
