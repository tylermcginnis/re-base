...
describe('bindToState()', function() {
  ...
  it('bindToState() throws an error given a invalid endpoint', done => {
  ...
  describe('Async tests', function() {
    it('bindToState() invokes .then when the initial listener is set', done => {
    ...
    it('bindToState() invokes .onFailure with error if permissions do not allow read', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() updates its local state with an empty array and object when the Firebase endpoint is null', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() updates its local state with defaultValue when the Firebase endpoint is null and defaultValue is set', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() properly updates the local state property when the Firebase endpoint changes', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() properly updates the local state nested property when the Firebase endpoint changes', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() properly updates the local state nested property (with sibling) when the Firebase endpoint changes', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() properly updates the local state property when the Firebase endpoint changes and asArray is true', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState() properly updates the local state property even when Firebase has initial date before bindToState is called', done => {
      class TestComponent extends React.Component {
        constructor(props) {
          super(props);
          this.state = {
    ...
    it('bindToState should allow multiple components to listen to changes on the same endpoint', done => {
