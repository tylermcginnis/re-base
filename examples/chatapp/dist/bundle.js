...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsContainerJsx = __webpack_require__(158);

	var _componentsContainerJsx2 = _interopRequireDefault(_componentsContainerJsx);

	var _componentsNewChatJsx = __webpack_require__(181);

	var _componentsNewChatJsx2 = _interopRequireDefault(_componentsNewChatJsx);

	var _reBase = __webpack_require__(159);

	var _reBase2 = _interopRequireDefault(_reBase);

	window.React = _react2['default'];

	var base = _reBase2['default'].createClass('https://jt-ts.firebaseio.com/rebase-chat');
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_componentsNewChatJsx2['default'], { chats: this.state.messages }),
	        _react2['default'].createElement(_componentsContainerJsx2['default'], null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = (function (_React$Component) {
	  ...
	  _createClass(Container, [{
	    ...
	    key: '_removeMessage',
	    value: function _removeMessage(index, e) {
	      e.stopPropagation();
	      ...
	      this.setState({ messages: arr, show: null });
	    }
	  }, {
	    key: '_toggleView',
	    value: function _toggleView(index) {
	    ...
	    value: function render() {
	      ...
	      var messages = this.state.messages.map ? this.state.messages.map(function (item, index) {
	        return _react2['default'].createElement(_messageJsx2['default'], {
	          thread: item,
	          show: _this.state.show === index,
	          removeMessage: _this._removeMessage.bind(_this),
	          handleClick: _this._toggleView.bind(_this),
	          index: index,
	          key: index
	        });
	      }) : [];
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'h1',
	            null,
	            (this.state.messages.length || 0) + ' messages'
	          ),
	          _react2['default'].createElement(
	            'ul',
	            null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			module.exports = factory(__webpack_require__(161));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = _reactAddons2['default'].createClass({
	  displayName: 'Message',

	  render: function render() {
	    return _reactAddons2['default'].createElement(
	      'li',
	      { onClick: this.props.handleClick.bind(null, this.props.index), className: this.props.show ? 'bg-warning' : 'bg-info' },
	      _reactAddons2['default'].createElement(
	        'button',
	        { onClick: this.props.removeMessage.bind(null, this.props.index), className: 'btn btn-danger' },
	        'X'
	      ),
	      this.props.thread.title,
	      this.props.show && _reactAddons2['default'].createElement(
	        'p',
	        null,
	        ' ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewChat = (function (_React$Component) {
	  function NewChat(props) {
	    ...
	    _get(Object.getPrototypeOf(NewChat.prototype), 'constructor', this).call(this, props);
	  }
	  ...
	  _createClass(NewChat, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'form',
	          { onSubmit: this._newChat.bind(this), className: 'form-group col-md-8' },
	          _react2['default'].createElement('input', { ref: 'title', type: 'text', placeholder: 'Title', className: 'form-control' }),
	          _react2['default'].createElement('textarea', { ref: 'message', placeholder: 'Message', className: 'form-control' }),
